...
public class PCItems
{
	...
	public static final RegistryObject<Item> CRAB_MEAT					= RegistryUtils.createItem("crab_meat", () -> new Item(new Item.Properties().group(PandorasCreatures.PANDORAS_CREATURES_GROUP).food(PCFoods.CRAB_MEAT(false))));
	public static final RegistryObject<Item> CRAB_MEAT_COOKED			= RegistryUtils.createItem("crab_meat_cooked", () -> new Item(new Item.Properties().group(PandorasCreatures.PANDORAS_CREATURES_GROUP).food(PCFoods.CRAB_MEAT(true))));
	...
	public static final RegistryObject<Item> SEAHORSE               	= RegistryUtils.createItem("seahorse", () -> new Item(new Item.Properties().group(PandorasCreatures.PANDORAS_CREATURES_GROUP).food(PCFoods.SEAHORSE(false))));
	public static final RegistryObject<Item> SEAHORSE_COOKED            = RegistryUtils.createItem("seahorse_cooked", () -> new Item(new Item.Properties().group(PandorasCreatures.PANDORAS_CREATURES_GROUP).food(PCFoods.SEAHORSE(true))));
	public static final RegistryObject<Item> ACIDIC_ARCHVINE_TONGUE     = RegistryUtils.createItem("acidic_archvine_tongue", () -> new Item(new Item.Properties().group(PandorasCreatures.PANDORAS_CREATURES_GROUP)));
	public static final RegistryObject<Item> HERB_BUNDLE                = RegistryUtils.createItem("herb_bundle", () -> new Item(new Item.Properties().group(PandorasCreatures.PANDORAS_CREATURES_GROUP)));
	public static final RegistryObject<Item> BUFFLON_BEEF               = RegistryUtils.createItem("bufflon_beef", () -> new Item(new Item.Properties().group(PandorasCreatures.PANDORAS_CREATURES_GROUP).food(PCFoods.BUFFLON_BEEF(false))));
	public static final RegistryObject<Item> BUFFLON_BEEF_COOKED        = RegistryUtils.createItem("bufflon_beef_cooked", () -> new Item(new Item.Properties().group(PandorasCreatures.PANDORAS_CREATURES_GROUP).food(PCFoods.BUFFLON_BEEF(true))));
	public static final RegistryObject<Item> BUFFLON_HIDE               = RegistryUtils.createItem("bufflon_hide", () -> new Item(new Item.Properties().group(PandorasCreatures.PANDORAS_CREATURES_GROUP)));
	public static final RegistryObject<Item> BUFFLON_SADDLE             = RegistryUtils.createItem("bufflon_saddle", () -> new Item(new Item.Properties().group(PandorasCreatures.PANDORAS_CREATURES_GROUP).maxStackSize(1)));
	public static final RegistryObject<Item> BUFFLON_PLAYER_SEATS       = RegistryUtils.createItem("bufflon_player_seats", () -> new Item(new Item.Properties().group(PandorasCreatures.PANDORAS_CREATURES_GROUP).maxStackSize(1)));
	public static final RegistryObject<Item> BUFFLON_SMALL_STORAGE      = RegistryUtils.createItem("bufflon_small_storage", () -> new Item(new Item.Properties().group(PandorasCreatures.PANDORAS_CREATURES_GROUP).maxStackSize(1)));
	public static final RegistryObject<Item> BUFFLON_LARGE_STORAGE      = RegistryUtils.createItem("bufflon_large_storage", () -> new Item(new Item.Properties().group(PandorasCreatures.PANDORAS_CREATURES_GROUP).maxStackSize(1)));
	...
	public static final RegistryObject<Item> END_TROLL_SKIN             = RegistryUtils.createItem("end_troll_skin", () -> new Item(new Item.Properties().group(PandorasCreatures.PANDORAS_CREATURES_GROUP)));
