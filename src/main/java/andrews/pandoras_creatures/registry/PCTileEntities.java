...
//	public static final RegistryObject<TileEntityType<PandoricShardTileEntity>> PANDORIC_SHARD = TILE_ENTITY_TYPES.register("pandoric_shard", () -> new TileEntityType<>(PandoricShardTileEntity::new, Sets.newHashSet(PCBlocks.PANDORIC_SHARD.get()), null)); TODO
...
//    	ClientRegistry.bindTileEntityRenderer(PANDORIC_SHARD.get(), PandoricShardTileEntityRenderer::new); TODO
    }
}