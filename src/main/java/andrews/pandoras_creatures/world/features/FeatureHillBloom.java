...
public class FeatureHillBloom// extends Feature<GrassFeatureConfig> TODO EVERYTHING
{	
//	public FeatureHillBloom(Function<Dynamic<?>, ? extends GrassFeatureConfig> config)
//	{
//		super(config);
//	}
//
