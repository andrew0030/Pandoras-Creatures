...
{		
	...
	private TranslationTextComponent buttonText = new TranslationTextComponent("gui.button.pandoras_creatures.patreon");
	
	public GuiButtonPatreon(CreativeScreen creativeTab, int xPos, int yPos) 
	{
