...
{		
	...
	public GuiButtonBufflonPeacefulMode(BufflonEntity entityIn, int xPos, int yPos) 
	{
	...
	public void renderButton(MatrixStack matrixStack, int mouseX, int mouseY, float partial)
	{
		...
		if(isHovered)
		{
//			String text = new TranslationTextComponent("gui.button.pandoras_creatures.bufflon.peaceful").getString(); TODO figure this shit out
