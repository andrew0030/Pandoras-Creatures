...
public class EndTrollBulletWitherEntity extends ShulkerBulletEntity
{
	...
	public EndTrollBulletWitherEntity(EntityType<? extends EndTrollBulletWitherEntity> entity, World world)
	{
		super(entity, world);
		this.noClip = true;
	}
	
	public EndTrollBulletWitherEntity(FMLPlayMessages.SpawnEntity spawnEntity, World world)
	{
		this(PCEntities.END_TROLL_BULLET_WITHER.get(), world);
	}

	@OnlyIn(Dist.CLIENT)
	public EndTrollBulletWitherEntity(World world, double x, double y, double z, double motionX, double motionY, double motionZ)
	{
		this(PCEntities.END_TROLL_BULLET_WITHER.get(), world);
	...
	public EndTrollBulletWitherEntity(World world, LivingEntity owner, Entity target, Direction.Axis direction)
	{
		this(PCEntities.END_TROLL_BULLET_WITHER.get(), world);
	...
	public void tick()
	{
		...
		if(this.world.isRemote)
		{
			this.world.addParticle(new RedstoneParticleData(0, 0, 0, 1.0F), this.getPosX() - vector3d1.x, this.getPosY() - vector3d1.y + 0.15D, this.getPosZ() - vector3d1.z, 0.0D, 0.0D, 0.0D);
		}
