...
public class EndTrollBulletDamageRenderer extends EntityRenderer<EndTrollBulletDamageEntity>
{
	...
	@Override
	public void render(EndTrollBulletDamageEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn)
	{
		matrixStackIn.push();
	...
	@Override
	public ResourceLocation getEntityTexture(EndTrollBulletDamageEntity entity)
	{
