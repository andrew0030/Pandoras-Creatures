...
{
	public EndTrollBulletModel<EndTrollBulletDamageEntity> model;

	public EndTrollBulletDamageRenderer(EntityRendererManager manager)
	{
		super(manager);
		this.model = new EndTrollBulletModel<EndTrollBulletDamageEntity>();
	}

	@Override
	public void doRender(EndTrollBulletDamageEntity entity, double x, double y, double z, float entityYaw, float partialTicks)
	{
	...
	@Override
	protected ResourceLocation getEntityTexture(EndTrollBulletDamageEntity entity)
	{
		return new ResourceLocation(Reference.MODID, "textures/entity/end_troll/bullets/end_troll_bullet_3.png");
	}
