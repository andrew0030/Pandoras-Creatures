package andrews.pandoras_creatures.entities.render.util;
...
public class PCRenderTypes extends RenderState
{
	public PCRenderTypes(String nameIn, Runnable setupTaskIn, Runnable clearTaskIn)
	{
	...
	public static RenderType getEmissiveEntity(ResourceLocation texture)
	{
		...
		return RenderType.makeType(Reference.MODID + ":entity_emissive_cutout", DefaultVertexFormats.ENTITY, 7, 256, true, false, state);
	}
}