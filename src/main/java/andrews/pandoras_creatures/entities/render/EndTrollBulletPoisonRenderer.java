...
{
	private static final ResourceLocation END_TROLL_BULLET_TEXTURE = new ResourceLocation(Reference.MODID, "textures/entity/end_troll/bullets/end_troll_bullet_1.png");
	private static final RenderType END_TROLL_BULLET_RENDER_TYPE = RenderType.getEntityTranslucent(END_TROLL_BULLET_TEXTURE);
	public EndTrollBulletModel<EndTrollBulletPoisonEntity> model;

	public EndTrollBulletPoisonRenderer(EntityRendererManager manager)
	{
		super(manager);
		this.model = new EndTrollBulletModel<EndTrollBulletPoisonEntity>();
	}
	
	@Override
	protected int getBlockLight(EndTrollBulletPoisonEntity entityIn, float partialTicks)
	{
		return 15;
	}

	@Override
	public void render(EndTrollBulletPoisonEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn)
	{
		matrixStackIn.push();
	...
	@Override
	public ResourceLocation getEntityTexture(EndTrollBulletPoisonEntity entity)
	{
