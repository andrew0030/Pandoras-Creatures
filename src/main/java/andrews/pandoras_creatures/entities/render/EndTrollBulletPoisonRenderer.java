...
public class EndTrollBulletPoisonRenderer extends EntityRenderer<EndTrollBulletPoisonEntity>
{
	...
	@Override
	public void doRender(EndTrollBulletPoisonEntity entity, double x, double y, double z, float entityYaw, float partialTicks)
	{
	...
	@Override
	protected ResourceLocation getEntityTexture(EndTrollBulletPoisonEntity entity)
	{
		return new ResourceLocation(Reference.MODID, "textures/entity/end_troll/bullets/end_troll_bullet_1.png");
	}
