...
public class EndTrollBulletPoisonEntity extends ShulkerBulletEntity
{
	...
	@OnlyIn(Dist.CLIENT)
	public EndTrollBulletPoisonEntity(World world, double x, double y, double z, double motionX, double motionY, double motionZ)
	{
		this(PCEntities.END_TROLL_BULLET_POISON.get(), world);
	...
	public EndTrollBulletPoisonEntity(World world, LivingEntity owner, Entity target, Direction.Axis direction)
	{
		this(PCEntities.END_TROLL_BULLET_POISON.get(), world);
